...
@Mod(modid = "itemrender", name = "Item Render", version = "1.3")
public class ItemRenderMod {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		if (gl32_enabled) {
			...
			FMLCommonHandler.instance().bus().register(new KeybindRenderEntity(512, "", Keyboard.KEY_SEMICOLON, "Render Entity (512)"));
			FMLCommonHandler.instance().bus().register(new KeybindRenderEntity(128, "_grid", Keyboard.KEY_APOSTROPHE, "Render Entity (128)"));
			...
			FMLCommonHandler.instance().bus().register(new KeybindRenderCurrentPlayer(1024, ""));
		}
	}
}
