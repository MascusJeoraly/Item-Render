...
public class CommandItemRender extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length == 0) {
            ...
            sender.addChatMessage(new ChatComponentText(EnumChatFormatting.AQUA + "Execute this command to control entity/item rendering scale."));
            ...
            if (args.length == 2) {
                ...
                sender.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "Execute /itemrender scale [value] to control entity/item rendering " + EnumChatFormatting.RED + "scale."));
            }
        } else
